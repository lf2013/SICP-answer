...
; (define (set-left-branch tree v) (set! tree (list (list v '() '()) (entry tree) (right-branch tree))) )
(define (set-right-branch tree v) (set-cdr! tree (list (left-branch tree) (list v '() '()))))
; (define (set-right-branch tree v) (set! tree (list (left-branch tree) (entry tree) (list v '() '()))))
