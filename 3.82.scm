...
(define (estimate-integral f x1 x2 y1 y2)
	...
	(display (stream-head s2 10)) (newline)
	(define mi-stream (stream-map (lambda (a b) (f a b)) s1 s2))
	(display (stream-head mi-stream 10)) (newline)
    (display (stream-head (monte-carlo mi-stream 0 0) 10)) (newline)
...
(define (try)
	(newline)
	; (display (stream-head pi2 10)) (newline)
	(display (stream-head (estimate-integral p 2.0 8.0 4.0 10.0) 10)) (newline)
	...
	(display (stream-ref pi2 100000)) (newline)
)
